...
public class VentaController {
  ...
  public String lista(Model model) {
    ...
    return "layout/administrador/ventas/listarVentas";
  }
  ...
  public String eliminarVenta(@PathVariable("id") Integer id, Model model, RedirectAttributes attribute) {
    ventaService.eliminar(id);
    System.out.println("Venta elimnado con exito");
    attribute.addAttribute("warning", "Venta elminado con exito");
